"""
Quiz para Semana 15: [Pendiente de definición]
...
# Templates de quiz para Semana 15 - ESTRUCTURA BÁSICA
QUIZ_TEMPLATES_WEEK15: List[Dict[str, Any]] = [
    # Template básico - reemplazar con contenido real
    {
        ...
        "solution_steps": [
            {
                "text": "Pendiente de implementación específica para semana 15",
        ...
        "wrong_options": [
            {
                ...
                "error_id": "error-pendiente-semana15"
            },
            {
                "wrong_steps": [
                    {
                ...
                "error_id": "error-pendiente-semana15-2"
            },
            {
                "wrong_steps": [
                    {
                ...
                "error_id": "error-pendiente-semana15-3"
            }
        ],
        "seed_id": "w15-1",
        "origin_label": "Se"
...
def get_quiz_templates_for_week15() -> List[Dict[str, Any]]:
    """
    Retorna los templates de quiz para la Semana 15.
    
    Returns:
        Lista de templates de quiz
    """
    return QUIZ_TEMPLATES_WEEK15


def generate_dynamic_question(base_question_latex: str) -> Optional[Dict[str, Any]]:
    """
    Genera un ejercicio dinámico basado en configuración de week15 usando LLM.
    ...
    # Usar la nueva función genérica para week15
    result = generate_quiz_instance('week15')
...
def get_random_question(use_dynamic: bool = False, base_question: str = None) -> Dict[str, Any]:
    """
    Retorna una instancia aleatoria del quiz de Semana 15 con opciones mezcladas.
    ...
    quiz_templates = get_quiz_templates_for_week15()
...
def choose_exercise_origin() -> str:
    """
    Decide pedagógicamente si usar un ejercicio seed o generado por LLM para week15.
...
week15_spec = WeekSpec(
    week_id="week15",
    title="Semana 15 - Pendiente de definición",
    subtitle="Contenido por definir",
    temas=["Pendiente"],
    tecnicas=["Pendiente"],
    descripcion="Contenido pendiente de implementación para semana 15",
    quiz_templates=QUIZ_TEMPLATES_WEEK15,
    error_tags=[]
)

register_week("week15", week15_spec)
