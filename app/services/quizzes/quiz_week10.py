"""
Quiz para Semana 10: [Pendiente de definición]
...
# Templates de quiz para Semana 10 - ESTRUCTURA BÁSICA
QUIZ_TEMPLATES_WEEK10: List[Dict[str, Any]] = [
    # Template básico - reemplazar con contenido real
    {
        ...
        "solution_steps": [
            {
                "text": "Pendiente de implementación específica para semana 10",
        ...
        "wrong_options": [
            {
                ...
                "error_id": "error-pendiente-semana10"
            },
            {
                "wrong_steps": [
                    {
                ...
                "error_id": "error-pendiente-semana10-2"
            },
            {
                "wrong_steps": [
                    {
                ...
                "error_id": "error-pendiente-semana10-3"
            }
        ],
        "seed_id": "w10-1",
        "origin_label": "Se"
...
def get_quiz_templates_for_week10() -> List[Dict[str, Any]]:
    """
    Retorna los templates de quiz para la Semana 10.
    
    Returns:
        Lista de templates de quiz
    """
    return QUIZ_TEMPLATES_WEEK10


def generate_dynamic_question(base_question_latex: str) -> Optional[Dict[str, Any]]:
    """
    Genera un ejercicio dinámico basado en configuración de week10 usando LLM.
    ...
    # Usar la nueva función genérica para week10
    result = generate_quiz_instance('week10')
...
def get_random_question(use_dynamic: bool = False, base_question: str = None) -> Dict[str, Any]:
    """
    Retorna una instancia aleatoria del quiz de Semana 10 con opciones mezcladas.
    ...
    quiz_templates = get_quiz_templates_for_week10()
...
def choose_exercise_origin() -> str:
    """
    Decide pedagógicamente si usar un ejercicio seed o generado por LLM para week10.
...
week10_spec = WeekSpec(
    week_id="week10",
    title="Semana 10 - Pendiente de definición",
    subtitle="Contenido por definir",
    temas=["Pendiente"],
    tecnicas=["Pendiente"],
    descripcion="Contenido pendiente de implementación para semana 10",
    quiz_templates=QUIZ_TEMPLATES_WEEK10,
    error_tags=[]
)

register_week("week10", week10_spec)
