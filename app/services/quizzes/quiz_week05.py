"""
Quiz para Semana 05: [Pendiente de definición]
...
# Templates de quiz para Semana 05 - ESTRUCTURA BÁSICA
QUIZ_TEMPLATES_WEEK05: List[Dict[str, Any]] = [
    # Template básico - reemplazar con contenido real
    {
        ...
        "solution_steps": [
            {
                "text": "Pendiente de implementación específica para semana 05",
        ...
        "wrong_options": [
            {
                ...
                "error_id": "error-pendiente-semana05"
            },
            {
                "wrong_steps": [
                    {
                ...
                "error_id": "error-pendiente-semana05-2"
            },
            {
                "wrong_steps": [
                    {
                ...
                "error_id": "error-pendiente-semana05-3"
            }
        ],
        "seed_id": "w05-1",
        "origin_label": "Se"
...
def get_quiz_templates_for_week05() -> List[Dict[str, Any]]:
    """
    Retorna los templates de quiz para la Semana 05.
    
    Returns:
        Lista de templates de quiz
    """
    return QUIZ_TEMPLATES_WEEK05


def generate_dynamic_question(base_question_latex: str) -> Optional[Dict[str, Any]]:
    """
    Genera un ejercicio dinámico basado en configuración de week05 usando LLM.
    ...
    # Usar la nueva función genérica para week05
    result = generate_quiz_instance('week05')
...
def get_random_question(use_dynamic: bool = False, base_question: str = None) -> Dict[str, Any]:
    """
    Retorna una instancia aleatoria del quiz de Semana 05 con opciones mezcladas.
    ...
    quiz_templates = get_quiz_templates_for_week05()
...
def choose_exercise_origin() -> str:
    """
    Decide pedagógicamente si usar un ejercicio seed o generado por LLM para week05.
...
week05_spec = WeekSpec(
    week_id="week05",
    title="Semana 05 - Pendiente de definición",
    subtitle="Contenido por definir",
    temas=["Pendiente"],
    tecnicas=["Pendiente"],
    descripcion="Contenido pendiente de implementación para semana 05",
    quiz_templates=QUIZ_TEMPLATES_WEEK05,
    error_tags=[]
)

register_week("week05", week05_spec)
