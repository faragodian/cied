"""
Quiz para Semana 12: [Pendiente de definición]
...
# Templates de quiz para Semana 12 - ESTRUCTURA BÁSICA
QUIZ_TEMPLATES_WEEK12: List[Dict[str, Any]] = [
    # Template básico - reemplazar con contenido real
    {
        ...
        "solution_steps": [
            {
                "text": "Pendiente de implementación específica para semana 12",
        ...
        "wrong_options": [
            {
                ...
                "error_id": "error-pendiente-semana12"
            },
            {
                "wrong_steps": [
                    {
                ...
                "error_id": "error-pendiente-semana12-2"
            },
            {
                "wrong_steps": [
                    {
                ...
                "error_id": "error-pendiente-semana12-3"
            }
        ],
        "seed_id": "w12-1",
        "origin_label": "Se"
...
def get_quiz_templates_for_week12() -> List[Dict[str, Any]]:
    """
    Retorna los templates de quiz para la Semana 12.
    
    Returns:
        Lista de templates de quiz
    """
    return QUIZ_TEMPLATES_WEEK12


def generate_dynamic_question(base_question_latex: str) -> Optional[Dict[str, Any]]:
    """
    Genera un ejercicio dinámico basado en configuración de week12 usando LLM.
    ...
    # Usar la nueva función genérica para week12
    result = generate_quiz_instance('week12')
...
def get_random_question(use_dynamic: bool = False, base_question: str = None) -> Dict[str, Any]:
    """
    Retorna una instancia aleatoria del quiz de Semana 12 con opciones mezcladas.
    ...
    quiz_templates = get_quiz_templates_for_week12()
...
def choose_exercise_origin() -> str:
    """
    Decide pedagógicamente si usar un ejercicio seed o generado por LLM para week12.
...
week12_spec = WeekSpec(
    week_id="week12",
    title="Semana 12 - Pendiente de definición",
    subtitle="Contenido por definir",
    temas=["Pendiente"],
    tecnicas=["Pendiente"],
    descripcion="Contenido pendiente de implementación para semana 12",
    quiz_templates=QUIZ_TEMPLATES_WEEK12,
    error_tags=[]
)

register_week("week12", week12_spec)
