"""
Quiz para Semana 14: [Pendiente de definición]
...
# Templates de quiz para Semana 14 - ESTRUCTURA BÁSICA
QUIZ_TEMPLATES_WEEK14: List[Dict[str, Any]] = [
    # Template básico - reemplazar con contenido real
    {
        ...
        "solution_steps": [
            {
                "text": "Pendiente de implementación específica para semana 14",
        ...
        "wrong_options": [
            {
                ...
                "error_id": "error-pendiente-semana14"
            },
            {
                "wrong_steps": [
                    {
                ...
                "error_id": "error-pendiente-semana14-2"
            },
            {
                "wrong_steps": [
                    {
                ...
                "error_id": "error-pendiente-semana14-3"
            }
        ],
        "seed_id": "w14-1",
        "origin_label": "Se"
...
def get_quiz_templates_for_week14() -> List[Dict[str, Any]]:
    """
    Retorna los templates de quiz para la Semana 14.
    
    Returns:
        Lista de templates de quiz
    """
    return QUIZ_TEMPLATES_WEEK14


def generate_dynamic_question(base_question_latex: str) -> Optional[Dict[str, Any]]:
    """
    Genera un ejercicio dinámico basado en configuración de week14 usando LLM.
    ...
    # Usar la nueva función genérica para week14
    result = generate_quiz_instance('week14')
...
def get_random_question(use_dynamic: bool = False, base_question: str = None) -> Dict[str, Any]:
    """
    Retorna una instancia aleatoria del quiz de Semana 14 con opciones mezcladas.
    ...
    quiz_templates = get_quiz_templates_for_week14()
...
def choose_exercise_origin() -> str:
    """
    Decide pedagógicamente si usar un ejercicio seed o generado por LLM para week14.
...
week14_spec = WeekSpec(
    week_id="week14",
    title="Semana 14 - Pendiente de definición",
    subtitle="Contenido por definir",
    temas=["Pendiente"],
    tecnicas=["Pendiente"],
    descripcion="Contenido pendiente de implementación para semana 14",
    quiz_templates=QUIZ_TEMPLATES_WEEK14,
    error_tags=[]
)

register_week("week14", week14_spec)
