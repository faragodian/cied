"""
Quiz para Semana 08: [Pendiente de definición]
...
# Templates de quiz para Semana 08 - ESTRUCTURA BÁSICA
QUIZ_TEMPLATES_WEEK08: List[Dict[str, Any]] = [
    # Template básico - reemplazar con contenido real
    {
        ...
        "solution_steps": [
            {
                "text": "Pendiente de implementación específica para semana 08",
        ...
        "wrong_options": [
            {
                ...
                "error_id": "error-pendiente-semana08"
            },
            {
                "wrong_steps": [
                    {
                ...
                "error_id": "error-pendiente-semana08-2"
            },
            {
                "wrong_steps": [
                    {
                ...
                "error_id": "error-pendiente-semana08-3"
            }
        ],
        "seed_id": "w08-1",
        "origin_label": "Se"
...
def get_quiz_templates_for_week08() -> List[Dict[str, Any]]:
    """
    Retorna los templates de quiz para la Semana 08.
    
    Returns:
        Lista de templates de quiz
    """
    return QUIZ_TEMPLATES_WEEK08


def generate_dynamic_question(base_question_latex: str) -> Optional[Dict[str, Any]]:
    """
    Genera un ejercicio dinámico basado en configuración de week08 usando LLM.
    ...
    # Usar la nueva función genérica para week08
    result = generate_quiz_instance('week08')
...
def get_random_question(use_dynamic: bool = False, base_question: str = None) -> Dict[str, Any]:
    """
    Retorna una instancia aleatoria del quiz de Semana 08 con opciones mezcladas.
    ...
    quiz_templates = get_quiz_templates_for_week08()
...
def choose_exercise_origin() -> str:
    """
    Decide pedagógicamente si usar un ejercicio seed o generado por LLM para week08.
...
week08_spec = WeekSpec(
    week_id="week08",
    title="Semana 08 - Pendiente de definición",
    subtitle="Contenido por definir",
    temas=["Pendiente"],
    tecnicas=["Pendiente"],
    descripcion="Contenido pendiente de implementación para semana 08",
    quiz_templates=QUIZ_TEMPLATES_WEEK08,
    error_tags=[]
)

register_week("week08", week08_spec)
